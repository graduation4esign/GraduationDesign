			...
			<div class="cn5_top_y center01">
				<div class="cn5topy_1">
					<div class="cn5topy_imgview">
						<img src="${sessionScope.productInfo.img}" />
						<ul class="cn5topy_imglist">
							<li><a href="#"><img
									src="${sessionScope.productInfo.img}"></a></li>
				...
				<div class="cn5topy_2">
					<h1 class="pro_title font15">${sessionScope.productInfo.name}</h1>
					<div class="pro_price">
					...
					<div class="pro_ship">
						<div>
							<div class="pro_key fl">剩&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;余：${sessionScope.productInfo.remain}</div>
						</div>
					</div>
					<form action="toaddshopcar" method="post">

						<input type="hidden" value="${sessionScope.user.id}" name="userId">
						<input type="hidden" value="${sessionScope.productInfo.id}" name="productId">
						<div class="pro_buy">
		...
		<div class="c5_b2">
			...
			<div class="c5_b2_right">
				...
				<div class="intro_pics">
					<img class="intro_pic" src="${productInfo.img}">
				</div>
			</div>
