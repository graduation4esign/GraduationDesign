    	...
    	<div class="cn5_top">
            ...
            <div class="cn5_top_y center01">
            	<div class="cn5topy_1">
                	<div class="cn5topy_imgview">
                        ...
                        <ul class="cn5topy_imglist">
                        	<li><a href="#"><img src="${book.img}"></a></li>
                            <li class="current"><a href="#"><img src="${book.img}"></a></li>
                            <li><a href="#"><img src="${book.img}"></a></li>
                            <li><a href="#"><img src="${book.img}"></a></li>
                            <li><a href="#"><img src="${book.img}"></a></li>
                        </ul>
                ...
                <div class="cn5topy_2">
                    ...
                    <form action="toaddshopcar">
                    <div class="pro_buy">
                    	<div class="pro_buy_nums">
                        	<input type="text" value="1" name="bookNum"/>
                            <dl>
                            	<dd id="add">+</dd>
                                <dd id="minus">-</dd>
                            </dl>
                ...
                <!--内容-->
              	<div class="c5_b2_right_1 box">
                    ...
                    <div class="intro_pics">
                    	<img class="intro_pic" src="${book.img}">
                    </div>
                </div>
